...
<img src="/assets/images/18065443_yNLG.png" width="640" />

在下面的截图中你可以看到命令是如何在更大的目录中搜寻。

<img src="/assets/images/18065444_oGZ6.png" width="640" />
...
<img src="/assets/images/18065446_R7wl.png" width="640" />
...
<img src="/assets/images/18065448_Tp5f.png" width="340" />

然而，一个git reflog命令则展示了一次commit (b1b0ee9&#8211;HEAD@{4})，它正是我刚才进行强制重置时弄丢的：

<img src="/assets/images/18065449_EkvH.png" width="640" />
...
![github](/assets/images/18065450_hN4c.png)

然后再看看在 add 命令中添加 -p 参数是怎样的？

![github](/assets/images/18065450_2QTu.png)
...
![github](/assets/images/18065451_0p2W.png)

正如你所看到的，我们添加了第一行和第三行而忽略了第二行。之后你可以查看仓库状态之后并进行提交。

<img src="/assets/images/18065452_SaJC.png" width="640" />
...
<img src="/assets/images/18065452_tDFb.png" width="640" />

然后会要求你为新的commit录入提交信息。这一过程本质上重写了你的commit历史。

<img src="/assets/images/18065453_4Hr2.png" width="640" />
...
<img src="/assets/images/18065454_vqeD.png" width="640" />
...
<img src="/assets/images/18065454_FLV5.png" width="640" />
...
<img src="/assets/images/18065455_S91t.png" width="640" />
...
![github](/assets/images/18065455_D0rX.png)

我切换到想被cherry-pick应用到的这个分支上去，然后运行了如下命令：

    git cherry-pick [commit_hash]

![github](/assets/images/18065456_15QD.png)
...
原文地址：http://www.sitepoint.com/10-tips-git-next-level/